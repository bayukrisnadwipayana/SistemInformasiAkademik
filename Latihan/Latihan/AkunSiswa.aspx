...
<body>
    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade" id="nav-upload" role="tabpanel" aria-labelledby="nav-upload-tab">
        ...
        <br /><br />
        <asp:GridView ID="gridviewsurat" runat="server" AutoGenerateColumns="false" DataKeyNames="nis" CssClass="table table-active table-bordered" HeaderStyle-BackColor="Aqua">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Keterangan">
                    <ItemTemplate>
                        <asp:Button ID="tombolhapussurat" runat="server" CssClass="btn btn-danger" Text="Hapus" OnClick="EventHapusSurat" OnClientClick="return confirm('Anda Yakin Ingin Menghapus?')" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
